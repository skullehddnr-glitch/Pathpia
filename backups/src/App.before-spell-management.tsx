          ...
          <div className="wide-panel spells-page">
            <div className="spells-head">
              <div>
                <h2>주문</h2>
                <p className="muted">
                  주문 슬롯과 주문 준비/습득 메모를 관리합니다. 현재는 기본 슬롯 요약 중심이며,
                  능력치 보너스 슬롯, 도메인 슬롯, 전문학파 슬롯, 아키타입 보정은 이후 단계에서 추가합니다.
                </p>
              </div>
            </div>
